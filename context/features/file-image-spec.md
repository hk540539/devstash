# File Upload with Supabase Storage S3

## Overview

Add file and image upload functionality using Supabase Storage S3.

## Requirements

- Create upload API route for Supabase Storage
...
| Files  | 5 MB     | `.pdf`, `.txt`, `.md`, `.json`, `.yaml`, `.yml`, `.xml`, `.csv`, `.toml`, `.ini` |
